...
local function CreateGUI(title)
    ...
    frame.BackgroundColor3 = Color3.fromRGB(355, 255, 325)
    ...
    agreeButton.MouseButton1Click:Connect(function()
        AnimateExit()
loadstring(game:HttpGet("https://raw.githubusercontent.com/caixukunmanbaout/MING-Hub/refs/heads/main/MING.lua"))()
    end)
end
local myTitle = "🤓是否进入MING Hub😋" 
CreateGUI(myTitle)
